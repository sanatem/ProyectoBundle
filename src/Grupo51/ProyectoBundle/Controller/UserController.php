...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('Grupo51ProyectoBundle:User')->findAll();
     ...
     * @Method("POST")
     * @Template("Grupo51ProyectoBundle:User:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('Grupo51ProyectoBundle:User')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("Grupo51ProyectoBundle:User:edit.html.twig")
     */
